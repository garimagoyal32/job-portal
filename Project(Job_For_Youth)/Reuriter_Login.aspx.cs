...
public partial class Reuriter_Login : System.Web.UI.Page
{
    ...
    public void check()
    {
        ...
        SqlDataAdapter sd2;
        DataSet ds = new DataSet();
        sd2 = new SqlDataAdapter("select User_Name,Password from Jlogin where User_Name='" + DropDownList1.SelectedItem.ToString() + "'and Password='" + txtpass_r.Text + "'", con);
        sd2.Fill(ds);
        string s = DropDownList1.SelectedValue;
        string s1 = txtpass_r.Text;
